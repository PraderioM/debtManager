...
from backend.utils.remove_data_utils import remove_flow_data


async def remove_flow(request: web.Request) -> web.Response:
    ...
    id_ = int(id_str)
    remove_flow_data(group_name, id_)
    return web.Response(status=201,
                        body="Flow removed successfully.")